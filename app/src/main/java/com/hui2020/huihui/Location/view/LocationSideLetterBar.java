package com.hui2020.huihui.Location.view;
...
public class LocationSideLetterBar extends View {
    ...
    public LocationSideLetterBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public LocationSideLetterBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
