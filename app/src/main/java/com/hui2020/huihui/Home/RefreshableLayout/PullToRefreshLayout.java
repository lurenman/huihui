...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //Log.d("PullToRefreshLayout", "updateHandler");
            // 刷新布局,会自动调用onLayout
            requestLayout();
            // 没有拖拉或者回弹完成
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText("会会即将帮您刷新...");
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText("会会正在努力刷新...");
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText("会会即将帮您加载...");
            ...
            case LOADING:
                ...
                loadStateTextView.setText("会会正在帮您加载...");
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                break;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //Log.d("PullToRefreshLayout", "onLayout");
        if (!isLayout) {
            // 这里是第一次进来的时候做一些初始化
